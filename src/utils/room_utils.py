...
def get_room_occupancy(
    alocacao_repo: AlocacaoRepository, room_id: int, semester_id: int
) -> int:
    """
    ...
    try:
        ...
        current_allocations = alocacao_repo.get_by_sala_and_semestre(
            room_id, semester_id
        )
        ...
        try:
            ...
            while prev_semester_id > 0:
                prev_allocations = alocacao_repo.get_by_sala_and_semestre(
                    room_id, prev_semester_id
                )
