...
class OptimizedAllocationRepository(
    BaseRepository[AlocacaoSemestralCreate, AlocacaoSemestralRead]
):
    ...
    def check_conflicts_batch(
        self, room_time_slots: List[Tuple[int, int, str]], semester_id: int
    ...
    def create_batch_atomic(
        self, allocation_dtos: List[AlocacaoSemestralCreate]
    ...
    def get_existing_allocations_for_demands(
        self, demanda_ids: List[int], semester_id: int
