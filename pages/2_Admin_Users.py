"""
Admin Users Management Page - Sistema de Ensalamento FUP/UnB
...
try:
    ...
    def main():
        ...
        # Main content - delegate to existing users page
        ...
        try:
            ...
            if DatabaseErrorHandler.is_detached_instance_error(e):
                ...
                st.error("❌ Erro ao carregar página de usuários.")
                st.warning(
    ...
    def run_page():
        ...
        try:
            ...
            logger.exception(f"Error in Admin Users page: {e}")
    ...
    logger.exception(f"Critical error loading Admin Users page: {e}")
